          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            ...
            <div>
              ...
              <div className="mb-6">
                ...
                <ul className="grid grid-cols-2 gap-2">
                  <li>
                    <Link to="/" className="text-white/80 hover:text-kote-turquoise transition-all duration-300">
                      Accueil
                    </Link>
                  </li>
                  <li>
                    <Link to="/catalogue" className="text-white/80 hover:text-kote-turquoise transition-all duration-300">
                      Tous nos produits
                    </Link>
                  </li>
                  <li>
                    <Link to="/services" className="text-white/80 hover:text-kote-turquoise transition-all duration-300">
                      Nos services
                    </Link>
                  </li>
                  <li>
                    <Link to="/blog" className="text-white/80 hover:text-kote-turquoise transition-all duration-300">
                      Blog & Conseils
                    </Link>
                  </li>
                  <li>
                    <Link to="/realisations" className="text-white/80 hover:text-kote-turquoise transition-all duration-300">
                      Nos réalisations
                    </Link>
                  </li>
                  <li>
                    <Link to="/contact" className="text-white/80 hover:text-kote-turquoise transition-all duration-300">
                      Contact
                    </Link>
                  </li>
                </ul>
            ...
            <div>
              ...
              <address className="not-italic text-white/80">
                <p>Route du Helleux</p>
                <p>97180 Sainte-Anne, Guadeloupe</p>
                <p className="mt-4">
                  <a 
                    href="tel:0590681662" 
                ...
                <p className="mt-2">
                  <a 
                    href="mailto:contact@kote-piscine-guadeloupe.com" 
                    className="flex items-center text-white/80 hover:text-kote-turquoise transition-all duration-300"
                  >
                    <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                      <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 8l7.89 5.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                    </svg>
                    contact@kote-piscine-guadeloupe.com
                  </a>
                </p>
              </address>
